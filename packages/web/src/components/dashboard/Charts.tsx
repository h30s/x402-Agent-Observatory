...
export function VolumeChart({ data }: VolumeChartProps) {
    return (
        <div className="card p-6 border border-[var(--border)] bg-white shadow-sm">
            <div className="mb-6">
                <h2 className="text-base font-semibold text-[var(--text-primary)]">
                    Volume Trends
                </h2>
                <p className="text-xs text-[var(--text-muted)]">24-hour transaction volume aggregated across protocols</p>
            </div>
    ...
    return (
        <div className="card p-6 border border-[var(--border)] bg-white shadow-sm">
            <div className="mb-6">
                ...
                <p className="text-xs text-[var(--text-muted)]">Market share by transaction volume</p>
            </div>
